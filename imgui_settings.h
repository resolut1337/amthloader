#include "../amthloader/ImGui/imgui.h"

namespace c
{
	namespace menu_sett {
		inline ImColor menu_color_swither = ImColor(255, 0, 255, 255);
	}
	...
	namespace bg
	{
		...
		inline ImVec2 size = ImVec2(400.f, 380.f); //loader
	...
	namespace child
	{
		...
		inline ImVec4 outline_background = ImColor(27, 29, 32, 255);
		inline ImVec4 outline_background_Test = ImColor(27, 29, 32, 255);
