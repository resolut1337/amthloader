...
bool CAuth::example()
{
	...
	if (std::find(Vars.User.secondary_group_ids.begin(), Vars.User.secondary_group_ids.end(), 5) != Vars.User.secondary_group_ids.end() 
		|| std::find(Vars.User.secondary_group_ids.begin(), Vars.User.secondary_group_ids.end(), 6) != Vars.User.secondary_group_ids.end()
		|| std::find(Vars.User.secondary_group_ids.begin(), Vars.User.secondary_group_ids.end(), 7) != Vars.User.secondary_group_ids.end()
		|| std::find(Vars.User.secondary_group_ids.begin(), Vars.User.secondary_group_ids.end(), 9) != Vars.User.secondary_group_ids.end()
