...
#define IM_DRAWLIST_CIRCLE_AUTO_SEGMENT_MIN                     0
...
//#endif
    ...
    IMGUI_API static bool BeginChildEx_custom(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags);
    IMGUI_API bool          BeginChildEx(const char* logo, const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags);
    ...
    IMGUI_API bool          BeginTableEx(const char* logo, const char* name, ImGuiID id, int columns_count, ImGuiTableFlags flags = 0, const ImVec2& outer_size = ImVec2(0, 0), float inner_width = 0.0f);
    ...
    IMGUI_API bool          Keybind(const char* label, int* key, bool show_label);
    IMGUI_API void          keybind_popup(const char* str_id, const char* label, int* key, int* key_mode, bool* binds, bool* value);
    IMGUI_API void          KeybindPicker(const char* label, int* key, bool show_label, const char* label_picker, float col[4]);
    // Widgets
    IMGUI_API void          TextEx(const char* text, const char* text_end = NULL, ImGuiTextFlags flags = 0);
    IMGUI_API bool          SubTab(bool selected, ImTextureID image, const ImVec2& size_arg);
    IMGUI_API bool          Tab(bool selected, const char* icon, const char* label, const char* hint,  const ImVec2& size_arg, const char* number);
    IMGUI_API bool          ButtonEx(const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          ButtonExCustom(ImTextureID user_texture_id, const char* label, const char* subtime, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    ...
    IMGUI_API bool          CustomButton(ImGuiID id, ImTextureID texture_id, const ImVec2& size, const ImVec2& uv0, const ImVec2& uv1, ImU32 color);
